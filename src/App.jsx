...
function App() {
  ...
  const deleteOne = ()=> setResult(result.lastIndexOf(0, -1));
  const calculate = ()=>{
    try{
  ...
  return (
    <div className="min-h-screen w-screen flex flex-col items-center gap-10 px-3 py-10">
      ...
      <div className="bg-rose-400 p-4 max-w-96 rounded-md border-4 border-pink-400
      shadow-[0_1px_6px_5px#000000">
        ...
        text-red-500 text-sm tracking-wider border border-slte-400">Brand Calculator</p>
        <div className="grid grid-cols-4 gap-2">
          ...
          <button onClick={handleClick} type="button" className="operator" id="*">*</button>
          <button onClick={handleClick} type="button" className="number" id="=">4</button>
          <button onClick={handleClick} type="button" className="number" id="=">5</button>
          <button onClick={handleClick} type="button" className="number" id="=">6</button>
          <button onClick={handleClick} type="button" className="operator" id="-">-</button>
          ...
          <button onClick={handleClick} type="button" className="operator col-span-2" id="=">=</button>
        </div>
      </div>
    </div>
  )
